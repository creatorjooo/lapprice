...
export interface StorePrice {
  ...
  priceState?: 'verified_fresh' | 'verified_stale' | 'unverified' | 'personalized' | 'failed';
  price_state?: 'verified_fresh' | 'verified_stale' | 'unverified' | 'personalized' | 'failed';
  ...
  isPdpUrl?: boolean;
  urlQuality?: 'pdp' | 'search' | 'invalid';
  url_quality?: 'pdp' | 'search' | 'invalid';
  affiliateUrl?: string;
